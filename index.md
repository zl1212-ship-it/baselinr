...
![Love plot of standardized effect sizes by
covariate](reference/figures/README-loveplot-1.png)

[`gt_baseline()`](https://zl1212-ship-it.github.io/baselinr/reference/gt_baseline.md)
renders the same table as a formatted `gt` table for reports and

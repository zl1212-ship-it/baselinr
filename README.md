...
<!-- badges: start -->
<!-- DRAFT: replace zl1212-ship-it after the repo is created. -->
...
[What Works Clearinghouse (WWC)](https://ies.ed.gov/ncee/wwc/). It does one
thing well: given a treatment indicator and a set of continuous covariates, it
reports the standardized mean difference (Hedges' g) and the WWC equivalence
...
Version 0.1.0 supports continuous covariates. Binary covariates (via the WWC
